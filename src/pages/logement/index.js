                ...
                <section className="logement__main-profil">
                  ...
                  <div className="logement__main-profil-rating">
                    <ul className="logement__main-profil-rating-list">
                      <li
                        style={
                          logement.rating >= 1 ? { color: "yellow" } : null
                        }
                      >
                        <FaStar />
                      </li>
                      <li
                        style={
                          logement.rating >= 2 ? { color: "yellow" } : null
                        }
                      >
                        <FaStar />
                      </li>
                      <li
                        style={
                          logement.rating >= 3 ? { color: "yellow" } : null
                        }
                      >
                        <FaStar />
                      </li>
                      <li
                        style={
                          logement.rating >= 4 ? { color: "yellow" } : null
                        }
                      >
                        <FaStar />
                      </li>
                      <li
                        style={
                          logement.rating >= 5 ? { color: "yellow" } : null
                        }
                      >
                        <FaStar />
                      </li>
